...
let mockItems: Item[] = [
  {
    ...
    images: ['https://placehold.co/300x300?text=Electric+Drill'],
    owner: mockUsers[1],
    isAvailable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/300x300?text=Garden+Hose'],
    owner: mockUsers[2],
    isAvailable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/300x300?text=Stand+Mixer'],
    owner: mockUsers[0],
    isAvailable: false,
    condition: ItemCondition.GOOD,
  ...
  },
  {
    ...
    category: ItemCategory.TOOLS,
    images: ['https://placehold.co/300x300?text=Ladder'],
    owner: mockUsers[1],
    isAvailable: true,
    condition: ItemCondition.GOOD,
